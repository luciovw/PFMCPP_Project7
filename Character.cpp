...
void Character::lvlUpStat(int& initialValue, int& stat)
{
...
void Character::lvlUpChar()
{
    lvlUpStat(*initialArmorLevel, armor);
    lvlUpStat(*initialHitPoints, hitPoints);
    lvlUpStat(*initialAttackDamage, attackDamage);
}
